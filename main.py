...
def add_group(update: Update, context: CallbackContext):
    for member in update.message.new_chat_members:
        update.message.reply_text(f'ආයුබෝවන් 🙏  <b>{member.user_name}</b> , 2021 A/L සෙට් එක 🏆 සමූහයට ඔබව සාදරයෙන් පිලිගන්නවා🤘🏽😍🤗😊. ලංකාව පුරා විසිරී සිටින Maths,Bio,Tech,Commerce,Art 2021 A/L ලියන ඔයාගෙම සහෝදර සහෝදරියන් මේ සමූහයේ ඉන්නේ...❤️\nසමූහයේ ප්‍රශ්නයක් ආවොත් admin කෙනකුට අනිවාර්යයෙන්ම කියන්න.😎\n\n Bot By:- @epusthakalaya_bots')
